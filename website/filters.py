...
class BookFilter(django_filters.FilterSet):
    ...
    course_subj = django_filters.CharFilter(field_name='course__subject', lookup_expr='iexact', label='Course Subject (abbr.)', distinct=True)
    course_cn = django_filters.CharFilter(field_name='course__catalog_number', lookup_expr='exact', label='Course Number', distinct=True)
